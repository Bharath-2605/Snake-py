...
class SnakeGameClass:
    def __init__(self, pathFood):
        ...
        self.score = 0
        self.highScore = 0  # Initialize high score
        self.gameOver = False
    ...
    def update(self, imgMain, currentHead):
        ...
        if self.gameOver:
            ...
            cvzone.putTextRect(imgMain, f'High Score: {self.highScore}', [300, 650], scale=7, thickness=5, offset=20)
        else:
            ...
            if len(self.points) > 10:
                ...
                if minDist >= -1:  # Collision detected
                    self.gameOver = True
                    # Update High Score
...
while True:
    ...
    if key == ord('r'):  # Restart game
        ...
        game.points = []  # Reset snake points
        game.lengths = []  # Reset snake lengths
        game.currentLength = 0  # Reset snake length
        game.allowedLength = 150  # Reset allowed length
        game.previousHead = 0, 0  # Reset head point
        game.randomFoodLocation()
    elif key == ord('e'):  # Exit game
